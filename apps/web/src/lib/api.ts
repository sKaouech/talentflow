...
export const tendersApi = {
  ...
  // Créer un tender
  create: (data: any): Promise<any> => api.post('/tenders', data),

  // Récupérer un tender par ID
  getById: (id: string): Promise<any> => api.get(`/tenders/${id}`),
  ...
  // Supprimer un tender
  delete: (id: string): Promise<void> => api.delete(`/tenders/${id}`),

  // Publier un tender
  publish: (id: string): Promise<any> => api.post(`/tenders/${id}/publish`),

  // Archiver un tender
  archive: (id: string): Promise<any> => api.post(`/tenders/${id}/archive`),

  // Obtenir les statistiques
  getStats: (): Promise<any> => api.get('/tenders/stats'),
