        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            {recentPlacements.map((placement, index) => (
              <div key={index} className="flex items-center justify-between p-4 rounded-lg border border-slate-200">
                <div className="flex-1">
                  <h3 className="font-medium text-slate-900 mb-1">{placement.candidate}</h3>
                  <p className="text-sm text-slate-600 mb-1">{placement.position}</p>
      ...
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 rounded-lg bg-slate-50">
            ...
            <div className="text-sm text-slate-600">Nouveaux appels d'offres</div>
          </div>
          <div className="text-center p-6 rounded-lg bg-slate-50">
